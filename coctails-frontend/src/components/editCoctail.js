    ...
    return (
        <fieldset>
            ...
            <form onSubmit={handleSubmit(submit)}>
                ...
                <div>Szkło <input type="text" {...register('glass')} defaultValue={thisCoctail.glass} required/></div>
                <div>Składniki
                    ...
                    <button type="button" className="btn btn-info" onClick={() => addElement()}>DODAJ SKŁADNIK</button>
                </div>
                <textarea {...register('steps')} rows="6" cols="75" required defaultValue={thisCoctail.steps.join('')}/>
                <button
                    className="register"
                    type="submit"
                >
